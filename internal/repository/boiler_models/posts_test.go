...
var (
	postDBTypes = map[string]string{`ID`: `bigint`, `Title`: `text`, `UserID`: `bigint`, `Content`: `text`, `CreatedAt`: `timestamp with time zone`, `Tags`: `ARRAYcharacter varying`, `UpdateAt`: `timestamp with time zone`}
	_           = bytes.MinRead
)
